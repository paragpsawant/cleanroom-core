...
import { DEFAULT_CATEGORIES, SECRET_LABEL_ONLY } from "../src/rules.js";
import { FaceDetector, tileStarts } from "../src/faces.js";
import { alignTokens, coordinatedNames, createNer, extendAddress, groupEntities, looksLikePersonInContext, toWordBoundaries, trimToNameWords } from "../src/ner.js";
import { OCR } from "../src/ocr.js";
import { groupRows, labelledValues, rowSpanBox, scan, spanBox } from "../src/pipeline.js";
import { readPng } from "../testing/png.mjs";
...
const run = (file, opts = {}) =>
  scan(readPng(join(web, "tests", "fixtures", file)), engines, { categories: DEFAULT_CATEGORIES, ...opts });
